        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          >
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-[#181d16]">
            ...
            <div className="mt-6 rounded-2xl overflow-hidden border border-[#e0e4d9] shadow-md relative">
              ...
              <img
                src="https://images.unsplash.com/photo-1527133256227-cf37781c6325?auto=format&fit=crop&q=80&w=800"
          ...
          >
            <div className="space-y-4 relative z-10">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold">Thông Tin Lô Hàng & Hộ Chiếu QR</h3>
                <p className="text-sm sm:text-base text-white/90 mt-2 leading-relaxed">
                  Hiển thị đầy đủ chứng nhận MRL, nhật ký phun bón, vùng trồng GPS và mã QR xác thực.
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          ...
          >
            <div className="space-y-3">
              ...
              <h3 className="text-xl font-bold text-[#181d16]">Smart Logistics</h3>
          ...
          >
            <div className="space-y-3 max-w-sm">
              ...
              <h3 className="text-xl font-bold text-[#181d16]">Cam kết Chất lượng</h3>
              <p className="text-sm sm:text-base text-[#40493d] leading-relaxed">
                Mọi đối tác đều qua quy trình xác minh 3 lớp và sở hữu chứng chỉ VietGAP/GlobalGAP.
              </p>
            </div>
            <div className="flex items-center gap-3 shrink-0">
              {['🌿 VIETGAP', '🌐 GLOBALGAP'].map((label) => (
                <div key={label} className="w-20 h-20 rounded-2xl bg-white border border-[#bfcaba]/50 p-2 flex flex-col items-center justify-center text-center shadow-xs">
                  <span className="text-xs font-bold text-[#181d16] tracking-tight">{label}</span>
                </div>
              ))}
            </div>
          </div>
