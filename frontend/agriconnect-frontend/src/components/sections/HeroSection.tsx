...
export const HeroSection: React.FC = () => {
  const { openMarketplace, openQrModal } = useUIStore();
    ...
    <section className="relative overflow-hidden pt-8 lg:pt-16 pb-12 lg:pb-20 px-4 lg:px-12 bg-[#f7fbf0]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-6 space-y-6 lg:space-y-8">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-[52px] font-bold text-[#181d16] leading-[1.15] tracking-tight">
            Kết Nối Nông Sản Việt Với <br className="hidden sm:inline" />
            <span className="text-[#176a22]">Thị Trường B2B</span>
          </h1>

          <p className="text-base sm:text-lg text-[#40493d] max-w-xl leading-relaxed">
          ...
          {/* Social proof */}
          <div className="pt-4 flex items-center gap-4 cursor-pointer group rounded-2xl p-2 -ml-2 hover:bg-[#ebefe4]/60 transition-all">
            <div className="flex -space-x-2 overflow-hidden">
              {[
                ...
                <img key={i} className="inline-block h-10 w-10 rounded-full ring-2 ring-[#f7fbf0] object-cover" src={src} alt="User avatar" />
              ))}
        ...
        <div className="lg:col-span-6 relative">
          <div className="relative rounded-[28px] overflow-hidden shadow-xl border border-[#e0e4d9]/80 bg-[#ebefe4]">
            ...
            {/* Floating card */}
            <div
              onClick={() => openQrModal('LOT-TL-2026-009')}
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <h4 className="text-base sm:text-lg font-bold text-[#181d16] leading-tight">
                    Thanh Long GlobalGAP
                  </h4>
                  <p className="text-sm font-bold text-[#176a22] mt-0.5">25.000 VNĐ/kg</p>
                </div>
              </div>
