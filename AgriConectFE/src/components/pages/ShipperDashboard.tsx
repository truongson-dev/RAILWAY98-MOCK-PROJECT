...
import { DashboardView } from '../shipper/DashboardView';
import { RoutesView } from '../shipper/RoutesView';
import { HistoryView } from '../shipper/HistoryView';
import { FleetView } from '../shipper/FleetView';
import { ShipmentTrackingView } from '../shipper/ShipmentTrackingView';
import { ShipmentsListView } from '../shipper/ShipmentsListView';
import { UserProfileCVView } from '../shipper/UserProfileCVView';
...
export const ShipperDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // TODO: Fetch vehicles, routes, notifications from actual endpoints
  }, []);
  ...
  return (
    <div className="bg-[#f7fbf0] text-[#181d16] antialiased min-h-screen w-full flex flex-col md:flex-row font-sans">
