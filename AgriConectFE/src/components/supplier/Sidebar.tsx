            ...
            <div className="space-y-1 pt-1">
              ...
              {onLogout && (
                <button
                  id="nav-item-logout"
                  onClick={onLogout}
                  className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors text-red-600 hover:bg-red-50 hover:text-red-700 mt-2"
                >
