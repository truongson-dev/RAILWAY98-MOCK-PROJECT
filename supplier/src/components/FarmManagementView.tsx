...
export const FarmManagementView: React.FC<FarmManagementViewProps> = ({
  ...
  const [products, setProducts] = useState<FarmProduct[]>([
    {
      id: 'prod-1',
      name: 'Sầu Riêng Ri6 VietGAP',
      plotName: 'Lô A2 - 2.5 Hecta',
      category: 'Trái cây ăn quả',
      areaHa: 2.5,
      expectedYieldTons: 5.0,
      priceVndPerKg: 88000,
      status: 'Đang chăm sóc',
      certifications: ['VietGAP', 'OCOP 4 sao'],
      imageUrl: 'https://images.unsplash.com/photo-1586771107445-d3ca888129ff?auto=format&fit=crop&w=400&q=80',
      stage: 'Dưỡng trái & Tích đường',
      progressPercent: 75,
      harvestDate: '15/10/2026',
      description: 'Sầu riêng Ri6 cơm vàng hạt lép, trồng theo quy trình sinh học VietGAP, cơm béo ngậy độ ngọt đạt 32-35 Brix.',
      createdAt: '2026-07-20'
    },
    {
      id: 'prod-2',
      name: 'Cà Phê Robusta Chín Cây',
      plotName: 'Lô B1 - 5.0 Hecta',
      category: 'Cây công nghiệp',
      areaHa: 5.0,
      expectedYieldTons: 12.0,
      priceVndPerKg: 118000,
      status: 'Sắp thu hoạch',
      certifications: ['GlobalGAP', '4C Coffee'],
      imageUrl: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?auto=format&fit=crop&w=400&q=80',
      stage: 'Chín rộ 98%',
      progressPercent: 95,
      harvestDate: '12/11/2026',
      description: 'Cà phê Robusta cao nguyên Đắk Lắk hái chín tay 100%, chế biến honey tinh chế thơm nồng nàn.',
    ...
    },
    {
      ...
      category: 'Trái cây ăn quả',
      areaHa: 1.8,
      expectedYieldTons: 4.5,
      priceVndPerKg: 62000,
      status: 'Đang chăm sóc',
      certifications: ['VietGAP'],
      imageUrl: 'https://images.unsplash.com/photo-1553279768-865429fa0078?auto=format&fit=crop&w=400&q=80',
      stage: 'Tạo tán & Bao trái',
      progressPercent: 60,
      harvestDate: '05/09/2026',
      description: 'Xoài Cát Hòa Lộc chuẩn thương hiệu Tiền Giang, trái to từ 450g-600g, vị ngọt đậm thơm mát.',
    ...
    },
    {
      ...
      stage: 'Thu hoạch rải rác',
      progressPercent: 85,
      harvestDate: '01/12/2026',
      description: 'Bưởi da xanh ruột hồng không hạt, mọng nước, tép bưởi giòn ngọt tỏi to đều.',
    ...
    },
    {
      ...
      stage: 'Trỗ bông chín vàng',
      progressPercent: 90,
      harvestDate: '25/08/2026',
      description: 'Gạo ST25 trồng trên mô hình Lúa - Tôm sinh thái không xịt thuốc hóa học, hạt gạo dẻo thơm vươn tầm thế giới.',
  ...
  const handleSaveProduct = (e: React.FormEvent) => {
    ...
    if (editingProductId) {
      ...
      const newProduct: FarmProduct = {
        ...
        priceVndPerKg: formPriceVnd,
        status: formStatus,
        certifications: formCertifications.length ? formCertifications : ['VietGAP'],
        imageUrl: formImageUrl || 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=400&q=80',
        stage: formStage,
        progressPercent: formProgress,
        harvestDate: formHarvestDate,
